...
public class CachingAspect {
    ...
    @Around("execution(* ru.mentee.banking.service.internal.AccountService.getBalanceById(String)) && args(accountId)")
    public Object getBalanceFromCache(ProceedingJoinPoint joinpoint, String accountId) throws Throwable{
        try{
